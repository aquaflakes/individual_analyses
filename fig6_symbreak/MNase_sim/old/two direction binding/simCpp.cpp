...
// 
// // [[Rcpp::export]]
// SEXP frag_mid_and_pos(LogicalMatrix MNaseCuts)
// {
//   
//   int ncol_= MNaseCuts.ncol();
//   int nrow_=MNaseCuts.nrow();
//   vector<vector<int>> midPoints;
//   vector<vector<int>> lengths;
//     midPoints.resize(nrow_);
//     lengths.resize(nrow_);
// 
//   for(int i=0; i< nrow_; i++)
//   {
//     // bool old_fragment=false;
...
//           if (p==ncol_-1) //count fragment if the final pos is false
//             {
//               lengths[i].push_back(fragLen);
//               midPoints[i].push_back( (((p+1)-1)+((p+1)-1-(fragLen-1))) /2 - half_size);
//             }
//         }
//       if (MNaseCuts(i,p)==true)
//         {
...
//           {
//             lengths[i].push_back(fragLen);
//             midPoints[i].push_back( ((p-1)+(p-1-(fragLen-1))) /2 - half_size);
//             fragLen=0;
//           }
//         }
//     }
//   }
//   return(Rcpp::List::create(_["fragMid"]=midPoints,_["fragLen"]=lengths));
// }
