...
#TFs with a EMI penetration (lig147) less than 20 are defined as having End preference
...
# According to the EMI penetration (lig147), TFs are classified into "Central binder" (>= 25), "Intermediate" (>=10), and "End binder" (<10)
