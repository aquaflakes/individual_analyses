...
// [[Rcpp::export]]
NumericMatrix pfm_from_seed(std::vector<std::string> seqs, std::string seed1="AAA",int gapLen=1, std::string seed2="AAA",
                            NumericVector seed1_start= NumericVector::create(2,3,4), int flankLen=4, bool all_start_with_specified_gap=true, bool two_strands=false) {
